...
def test_annualized_return(x,y,z,expected):
...
def test_annualized_sd(x,y,expected):
    if np.isnan(expected).all():
...
def test_cumulative_returns(x, y, expected):
...
def test_average_drawdown(x, y, expected):
...
def test_max_drawdown(x, y, expected):
...
def test_sharpe_ratio(x, y, z, m, expected):
...
def test_calmar_ratio(x, y, z, expected):
...
def test_burke_ratio(x, y, z, m, n, expected):
...
def test_downside_risk(x, y, z, expected):
...
def test_sortino_ratio(x,y,z,expected):
...
def test_tracking_error(x,y,z,expected):
...
def test_information_ratio(x,y,z,expected):
...
def test_capm_beta(x,y,expected):
...
def test_capm_alpha(x,y,z,m,n,expected):
...
def test_treynor_ratio(x, y, z, m, expected):
...
def test_skewness(x, y, expected):
...
def test_kurtosis(x, y, expected):
...
def test_value_at_risk(x, y, expected):
...
def test_conditional_value_at_risk(x, y, expected):
